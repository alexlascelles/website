...
songs = pd.read_csv(filename, skipinitialspace=True)
...
artist_counts_songs.to_csv(f'{folder}/artist_song_counts_{filename.rstrip(".csv")}.csv', index=False)
...
plt.tight_layout()
plt.savefig(f'{folder}/top_30_artists_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # High-resolution PNG
plt.show()
...
# Save to a new CSV file:
genre_counts_songs.to_csv(f'{folder}/genre_song_counts_{filename.rstrip(".csv")}.csv', index=False)
...
# Save the plot as a high-resolution PNG file
plt.tight_layout()
plt.savefig(f'{folder}/top_30_genres_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # High-resolution PNG
plt.show()
...
plt.legend()
plt.grid(axis='y')
plt.savefig(f'{folder}/song_length_distribution_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # High-resolution PNG
plt.show()
...
plt.savefig(f'{folder}/song_release_year_distribution_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # High-resolution PNG
plt.show()
...
plt.savefig(f'{folder}/song_release_decade_distribution_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # High-resolution PNG
plt.show()
...
plt.tight_layout()
plt.savefig(f'{folder}/songs_added_by_year_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # Save high-resolution plot
plt.show()
...
plt.tight_layout()
plt.savefig(f'{folder}/songs_added_by_month_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')  # Save high-resolution plot
plt.show()
...
plt.savefig(f'{folder}/continuous_properties_distribution_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')
plt.show()
...
plt.tight_layout(rect=[0, 0, 1, 0.96])
plt.savefig(f'{folder}/categorical_properties_distribution_{filename.rstrip(".csv")}.png', dpi=600, bbox_inches='tight')
plt.show()
